...
public class Board {
	...
	private void initializeBoard() {
		...
		for (int i = 0; i < nBombs; i++) {
			int r = i / nColumns;
			int c = (Math.abs(i - r * nColumns)) % nColumns;
			bombs[i] = cells[r][c];
	...
	/*
	 * Set the cells around the bombs to the right number. Although the bombs
	 * have been shuffled, the reference in the bombs array is still to same
	 * object.
	 */
